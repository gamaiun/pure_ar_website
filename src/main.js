...
navigator.geolocation.getCurrentPosition(
  (position) => {
    ...
    console.log("GPS position set:", cube.position);
  },
  (error) => {
...
if (typeof DeviceOrientationEvent.requestPermission === "function") {
  DeviceOrientationEvent.requestPermission()
    .then((permissionState) => {
      if (permissionState === "granted") {
        ...
        // Trigger a dummy orientation event to prompt permission if needed
  ...
  console.log("Device orientation API supported, no permission prompt needed.");
}
