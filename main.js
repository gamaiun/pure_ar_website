function getQueryParams() {
  ...
  window.onload = () => {
    ...
    // Load the 3D model
    const modelMap = {
      "Marker 1": "https://firebasestorage.googleapis.com/v0/b/ieye-453408.firebasestorage.app/o/ARObject1.glb?alt=media&token=3e5c3d8a-f4ff-4015-aebe-de9944ff8e65",
      "Marker 2": "https://firebasestorage.googleapis.com/v0/b/ieye-453408.firebasestorage.app/o/ARObject1.glb?alt=media&token=3e5c3d8a-f4ff-4015-aebe-de9944ff8e65",
      "Marker 3": "https://firebasestorage.googleapis.com/v0/b/ieye-453408.firebasestorage.app/o/ARObject1.glb?alt=media&token=3e5c3d8a-f4ff-4015-aebe-de9944ff8e65",
      "default": "https://firebasestorage.googleapis.com/v0/b/ieye-453408.firebasestorage.app/o/ARObject1.glb?alt=media&token=3e5c3d8a-f4ff-4015-aebe-de9944ff8e65",
    };
    ...
    navigator.geolocation.watchPosition(
      (position) => {
        ...
        const cartographicUser = Cesium.Cartographic.fromDegrees(userLon, userLat, 0);
        const cartographicTarget = Cesium.Cartographic.fromDegrees(gpsLon, gpsLat, 0);
        const surfaceUser = ellipsoid.cartographicToCartesian(cartographicUser);
        const surfaceTarget = ellipsoid.cartographicToCartesian(cartographicTarget);
  
        // Calculate the offset for camera positioning
        const userOffset = Cesium.Cartesian3.subtract(surfaceUser, surfaceTarget, new Cesium.Cartesian3());
        ...
        console.log(`Camera Position: x=${camX.toFixed(2)}km, z=${camZ.toFixed(2)}km`);
      },
      (error) => {
        console.error("GPS Error:", error.message);
        document.getElementById("loading").textContent = "GPS Error: " + error.message;
      },
